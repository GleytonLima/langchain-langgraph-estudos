...
Não tocamos Postgres/LM Studio: manifest() é puro; build_agent é exercitado via
o conftest (ScriptedModel + MemorySaver). Aqui cobrimos o manifesto e o get_llm,
que apenas constrói o ChatOpenAI (sem chamada de rede).
"""
...
def test_manifest_expoe_id_capabilities_e_hitl():
    ...
    assert m.name == "Agente de Despesas"
...
def test_build_agent_monta_grafo_compilavel():
    ...
    # um grafo compilado expõe invoke/get_state
